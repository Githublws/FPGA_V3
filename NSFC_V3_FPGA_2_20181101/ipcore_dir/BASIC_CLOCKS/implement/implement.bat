...
xst -ifn xst.scr
move BASIC_CLOCKS_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\BASIC_CLOCKS_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc BASIC_CLOCKS_exdes.ucf BASIC_CLOCKS_exdes

echo 'Running map'
map -timing -pr b BASIC_CLOCKS_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm BASIC_CLOCKS_exdes -w routed.ncd routed.v
cd ..
